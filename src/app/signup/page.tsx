...
export default function Page() {
  return (
    <div className="bg-no-repeat relative bg-cover bg-top-right min-h-screen overflow-hidden w-full flex flex-col-reverse md:grid sm:grid-cols-1 grid-cols-1 md:grid-cols-2 px-3 md:px-10 lg:px-20 py-3 md:py-10" style={{backgroundImage: "url('/images/signup-bg.png')"}}>
        
        <Link
            href={'/'}
            className='absolute z-1 flex items-center justify-center gap-2 top-6 md:top-10 max-sm:right-6 md:left-10 bg-white rounded-lg px-5 py-3 hover:bg-white/60 text-[#9B4B6A] shadow '
        >
