...
export default function PaternWithUs() {
    ...
    const paterners: PaternerType[] = [
        {
            title: "Retailers",
            icon:<svg className='h-6 w-6 sm:h-8 sm:w-8' viewBox="0 0 30 33" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            title: "Vendors",
            icon:<svg className='h-6 w-6 sm:h-8 sm:w-8' viewBox="0 0 28 31" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            title: "Manufacturers",
            icon:<svg className='h-6 w-6 sm:h-8 sm:w-8' viewBox="0 0 32 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div key={idx} className={`p-0 md:p-3 flex ${activeSection == idx ? `items-start` : `items-center`} justify-start gap-5 w-full`}>
                        ...
                        <div className="paterner-descs flex-1">
                            ...
                            >
                                ...
                                <button type="button" className={`flex h-8 w-8 items-center justify-center transform transition-transform duration-300 ${activeSection == idx ? `rotate-0`:`rotate-180`}`}>
                            ...
                            <div className={`about-paterners max-sm:-ml-10 overflow-hidden transition-all duration-500 ease-in-out ${activeSection == idx ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0'}`}>
