...
export default function PaternWithUs() {
  ...
  return (
    <div id='about' className="flex items-center justify-center flex-col gap-5 p-20">
        ...
        <div className="flex items-start justify-between gap-10 pt-10">
            <div className="h-full rounded-[50px] flex-2/5">
                <img
                    src="/images/patern-with-us-img.jpg"
                    alt=""
                    className="h-[776px] object-cover rounded-[50px]"
                    loading={"lazy"}
                />
            </div>

            <div className="contantents flex flex-col gap-8 items-start justify-start flex-3/5">
                {paterners.map((paterner, idx) =>(
                    <div key={idx} className={`p-3 flex ${activeSection == idx ? `items-start` : `items-center`} justify-start gap-5 w-full`}>
                        <div className="flex">
                            <CircledSpan>
                                {paterner.icon}
                            </CircledSpan>
